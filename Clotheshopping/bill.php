...
//{
    $uname= $_SESSION['email_id'];
     $idquery="select cust_id from `customer` where `email_id`='$uname'";
...
if(isset($_POST["placeorder"]))
{
  ...
  $cart_data = json_decode($cookie_data, true);
    ...
    foreach($cart_data as $keys => $values)
    {
     ...
     $insert = mysqli_query($con,"INSERT INTO order_items(order_id,qty,product_name,price,cust_id) VALUES ('$ordid','$qty','$product_name','$price','$uid')");
