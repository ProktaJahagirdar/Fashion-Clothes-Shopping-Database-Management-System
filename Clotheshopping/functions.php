...
/*function add_cart(){
    ...
    if(isset($_GET['add_cart'])){
        ...
        $product_unitprice= "select 'product_price' from products where product_id='$p_id'";
        ...
        if(mysqli_num_rows($run_check)>0){
            ...
            $query = "insert into cart (p_id,ip_add,qty,size,unitprice) values ('$p_id','$ip_add','$product_qty','$product_size','$product_unitprice')";
...
function getWCats(){
    ...
    while($row_p_cats=mysqli_fetch_array($run_p_cats)){
        ...
        echo "
            <li> 
                <a href='category.php?w_cat=$p_cat_id'> $p_cat_title </a>            
            </li>
        ";
...
function getMCats(){
    ...
    while($row_p_cats=mysqli_fetch_array($run_p_cats)){
        ...
        echo "
            <li> 
                <a href='category.php?m_cat=$p_cat_id'> $p_cat_title </a>            
            </li>
        ";
