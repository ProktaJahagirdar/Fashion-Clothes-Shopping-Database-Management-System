...
<head>
    ...
    <title>Euphoria | Fashion Quotient </title>
   ...
   <div id="top"><!-- Top Begin -->
       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="col-md-6 offer"><!-- col-md-6 offer Begin -->
               ...
               <a href="#" class="btn btn-success btn-sm">Welcome:<?php echo $_SESSION['email_id'] ?></a>
       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="navbar-header"><!-- navbar-header Begin -->
               ...
               <a href="home.php" class="navbar-brand home"><!-- navbar-brand home Begin -->
                   ...
                   <img src="images/euphoria cropped1.jpg" alt="Euphoria Logo">
