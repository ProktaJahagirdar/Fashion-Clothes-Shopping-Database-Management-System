               ...
               <form method="post" action="insert.php" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <select name="cat_id" class="form-control" required><!-- form-control Begin -->
...
if(isset($_POST['submit'])){
    ...
    $insert_product = "insert into menu_table (p_cat_id,cat_id,product_name,image,price,qty) values ('$product_category','$category','$product_name', '$product_img','$product_price','$product_qty')";
    ...
    if($run_product){
        ...
        echo "<script>window.open('admininsert_product.php','_self')</script>";
