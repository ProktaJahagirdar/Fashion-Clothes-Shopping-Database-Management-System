                           ...
                           <table class="table"><!-- table Begin -->
                               ...
                               <?php 
                                   ...
                                   while($row_cart = mysqli_fetch_array($run_cart)){
                                     ...
                                     $pro_unitprice = $row_cart['unitprice'];
                                       
                                     $price= ($row_cart["qty"] * $row_cart["unitprice"]);

                                     $total = $total + ($row_cart["qty"] * $row_cart["unitprice"]);
                                   }
                                   
                                   $insert_order = "insert into orders(ip_add,order_date,payment,purchase_amount) values('$ip_add','NOW()','0','$pur_amt')";
