...
if(isset($_POST['register'])){
    ...
    //    echo "Change it";
    //}else{
    $insert_customer = "insert into customers (cust_fname,cust_lname,email_id,phone_no,password,address,customer_ip) values('$cust_fname','$cust_lname','$email_id','$phone_no','$password','$address','$c_ip')" ;
    //}
